...
In breif, there are three steps for a DCNN model. Take demo2 as an example.
...
3. Rerun decouple alogorithm in NeuronMotif: [nm-2/demo2_2](https://github.com/wzthu/NeuronMotif/tree/master/nm-2/demo2_2)(optional if the results is fully decoupled).
